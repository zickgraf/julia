...
void jl_init_types(void) JL_GC_DISABLED
{
    ...
    *(size_t*)jl_an_empty_string = 0;
    ...
    jl_intermustalias_type = jl_new_datatype(jl_symbol("InterMustAlias"), core, jl_any_type, jl_emptysvec,
                                          jl_perm_symsvec(3, "slot", "fld", "fldtyp"),
                                          jl_svec(3, jl_long_type, jl_const_type, jl_any_type),
                                          jl_emptysvec, 0, 0, 3);
